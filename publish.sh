...
mkdocs build && rm -rf site/documentation || error "Error generating website"
git clone "$(git config --get remote.origin.url)" code || error "Error cloning Forge"
...
cd .. && cleanup
echo "Successfully published Forge documentation"
exit 0
